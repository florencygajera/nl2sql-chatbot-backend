...
_SYNONYMS: dict[str, set[str]] = {
    ...
    "tax": {"rctax", "rctaxmaster", "taxrequest", "tax_request", "taxpay", "tax_pay", "gst", "vat"},
    "unpaid": {"pending", "due", "notpaid", "not_paid", "unsettled"},
    "paid": {"payment", "receipt", "paidstatus", "completed"},
    "payment": {"paymentmaster", "pay", "receipt", "transaction"},
    "cheque": {"check", "chq"},
    "bank": {"acct", "account"},
    "status": {"state"},
